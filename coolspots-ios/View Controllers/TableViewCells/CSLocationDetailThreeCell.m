...
@implementation CSLocationDetailThreeCell {
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        egoImageView1.frame = CGRectMake(0, 0, 212, 212);
        ...
        egoImageView2.frame = CGRectMake(212, 0, 108, 108);
        ...
        egoImageView3.frame = CGRectMake(212, 105, 108, 108);
